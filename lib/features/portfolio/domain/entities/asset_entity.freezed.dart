...
mixin _$AssetEntity {
 ...
 int get id; int get portfolioId; String get ticker; String get name; double get holdings; double get invested;@JsonKey(name: 'avg_price') double get avgPrice;@JsonKey(name: 'break_even') double get breakEven;@JsonKey(name: 'realized_pnl') double get realizedPnl;@JsonKey(name: 'num_txs') int get numTxs;@JsonKey(name: 'base_ccy') String get baseCcy; double? get weight; double? get endPrice;@JsonKey(name: 'returnPct') double? get returnPct; double? get returnValue; double? get totalReturnPct; double? get totalReturnValue;/// Price points from API `base.chart` (in user's base currency).
...
@override
int get hashCode => Object.hashAll([runtimeType,id,portfolioId,ticker,name,holdings,invested,avgPrice,breakEven,realizedPnl,numTxs,baseCcy,weight,endPrice,returnPct,returnValue,totalReturnPct,totalReturnValue,const DeepCollectionEquality().hash(baseChart),const DeepCollectionEquality().hash(ccyChart)]);
...
/// Create a copy of AssetEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? portfolioId = null,Object? ticker = null,Object? name = null,Object? holdings = null,Object? invested = null,Object? avgPrice = null,Object? breakEven = null,Object? realizedPnl = null,Object? numTxs = null,Object? baseCcy = null,Object? weight = freezed,Object? endPrice = freezed,Object? returnPct = freezed,Object? returnValue = freezed,Object? totalReturnPct = freezed,Object? totalReturnValue = freezed,Object? baseChart = freezed,Object? ccyChart = freezed,}) {
...
switch (_that) {
case _AssetEntity() when $default != null:
return $default(_that.id,_that.portfolioId,_that.ticker,_that.name,_that.holdings,_that.invested,_that.avgPrice,_that.breakEven,_that.realizedPnl,_that.numTxs,_that.baseCcy,_that.weight,_that.endPrice,_that.returnPct,_that.returnValue,_that.totalReturnPct,_that.totalReturnValue,_that.baseChart,_that.ccyChart);case _:
  return orElse();
...
class _AssetEntity implements AssetEntity {
  const _AssetEntity({required this.id, required this.portfolioId, required this.ticker, required this.name, required this.holdings, required this.invested, @JsonKey(name: 'avg_price') required this.avgPrice, @JsonKey(name: 'break_even') required this.breakEven, @JsonKey(name: 'realized_pnl') required this.realizedPnl, @JsonKey(name: 'num_txs') required this.numTxs, @JsonKey(name: 'base_ccy') required this.baseCcy, this.weight, this.endPrice, @JsonKey(name: 'returnPct') this.returnPct, this.returnValue, this.totalReturnPct, this.totalReturnValue, final  List<double>? baseChart, final  List<double>? ccyChart}): _baseChart = baseChart,_ccyChart = ccyChart;
...
@override
int get hashCode => Object.hashAll([runtimeType,id,portfolioId,ticker,name,holdings,invested,avgPrice,breakEven,realizedPnl,numTxs,baseCcy,weight,endPrice,returnPct,returnValue,totalReturnPct,totalReturnValue,const DeepCollectionEquality().hash(_baseChart),const DeepCollectionEquality().hash(_ccyChart)]);
...
/// Create a copy of AssetEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? portfolioId = null,Object? ticker = null,Object? name = null,Object? holdings = null,Object? invested = null,Object? avgPrice = null,Object? breakEven = null,Object? realizedPnl = null,Object? numTxs = null,Object? baseCcy = null,Object? weight = freezed,Object? endPrice = freezed,Object? returnPct = freezed,Object? returnValue = freezed,Object? totalReturnPct = freezed,Object? totalReturnValue = freezed,Object? baseChart = freezed,Object? ccyChart = freezed,}) {
