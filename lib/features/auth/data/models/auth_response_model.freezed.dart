...
mixin _$AuthResponseModel {
 ...
 String get token;@JsonKey(name: 'refreshBefore') int get refreshBefore;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthResponseModel&&(identical(other.token, token) || other.token == token)&&(identical(other.refreshBefore, refreshBefore) || other.refreshBefore == refreshBefore));
}
...
@override
String toString() {
  return 'AuthResponseModel(token: $token, refreshBefore: $refreshBefore)';
}
...
@useResult
$Res call({
 String token,@JsonKey(name: 'refreshBefore') int refreshBefore
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String token, @JsonKey(name: 'refreshBefore')  int refreshBefore)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthResponseModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String token, @JsonKey(name: 'refreshBefore')  int refreshBefore)  $default,) {final _that = this;
switch (_that) {
case _AuthResponseModel():
return $default(_that.token,_that.refreshBefore);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String token, @JsonKey(name: 'refreshBefore')  int refreshBefore)?  $default,) {final _that = this;
switch (_that) {
case _AuthResponseModel() when $default != null:
return $default(_that.token,_that.refreshBefore);case _:
  return null;
...
class _AuthResponseModel implements AuthResponseModel {
  const _AuthResponseModel({required this.token, @JsonKey(name: 'refreshBefore') required this.refreshBefore});
  factory _AuthResponseModel.fromJson(Map<String, dynamic> json) => _$AuthResponseModelFromJson(json);

@override final  String token;
@override@JsonKey(name: 'refreshBefore') final  int refreshBefore;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthResponseModel&&(identical(other.token, token) || other.token == token)&&(identical(other.refreshBefore, refreshBefore) || other.refreshBefore == refreshBefore));
}
