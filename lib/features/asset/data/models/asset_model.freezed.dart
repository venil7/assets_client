...
mixin _$AssetMetaModel {
 ...
 String get range;@JsonKey(name: 'validRanges') List<String> get validRanges;@JsonKey(name: 'fiftyTwoWeekLow') double get fiftyTwoWeekLow;@JsonKey(name: 'fiftyTwoWeekHigh') double get fiftyTwoWeekHigh;@JsonKey(name: 'regularMarketPrice') double get regularMarketPrice;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AssetMetaModel&&(identical(other.range, range) || other.range == range)&&const DeepCollectionEquality().equals(other.validRanges, validRanges)&&(identical(other.fiftyTwoWeekLow, fiftyTwoWeekLow) || other.fiftyTwoWeekLow == fiftyTwoWeekLow)&&(identical(other.fiftyTwoWeekHigh, fiftyTwoWeekHigh) || other.fiftyTwoWeekHigh == fiftyTwoWeekHigh)&&(identical(other.regularMarketPrice, regularMarketPrice) || other.regularMarketPrice == regularMarketPrice));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,range,const DeepCollectionEquality().hash(validRanges),fiftyTwoWeekLow,fiftyTwoWeekHigh,regularMarketPrice);

@override
String toString() {
  return 'AssetMetaModel(range: $range, validRanges: $validRanges, fiftyTwoWeekLow: $fiftyTwoWeekLow, fiftyTwoWeekHigh: $fiftyTwoWeekHigh, regularMarketPrice: $regularMarketPrice)';
}
...
@useResult
$Res call({
 String range,@JsonKey(name: 'validRanges') List<String> validRanges,@JsonKey(name: 'fiftyTwoWeekLow') double fiftyTwoWeekLow,@JsonKey(name: 'fiftyTwoWeekHigh') double fiftyTwoWeekHigh,@JsonKey(name: 'regularMarketPrice') double regularMarketPrice
});
...
/// Create a copy of AssetMetaModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? range = null,Object? validRanges = null,Object? fiftyTwoWeekLow = null,Object? fiftyTwoWeekHigh = null,Object? regularMarketPrice = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String range, @JsonKey(name: 'validRanges')  List<String> validRanges, @JsonKey(name: 'fiftyTwoWeekLow')  double fiftyTwoWeekLow, @JsonKey(name: 'fiftyTwoWeekHigh')  double fiftyTwoWeekHigh, @JsonKey(name: 'regularMarketPrice')  double regularMarketPrice)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AssetMetaModel() when $default != null:
return $default(_that.range,_that.validRanges,_that.fiftyTwoWeekLow,_that.fiftyTwoWeekHigh,_that.regularMarketPrice);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String range, @JsonKey(name: 'validRanges')  List<String> validRanges, @JsonKey(name: 'fiftyTwoWeekLow')  double fiftyTwoWeekLow, @JsonKey(name: 'fiftyTwoWeekHigh')  double fiftyTwoWeekHigh, @JsonKey(name: 'regularMarketPrice')  double regularMarketPrice)  $default,) {final _that = this;
switch (_that) {
case _AssetMetaModel():
return $default(_that.range,_that.validRanges,_that.fiftyTwoWeekLow,_that.fiftyTwoWeekHigh,_that.regularMarketPrice);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String range, @JsonKey(name: 'validRanges')  List<String> validRanges, @JsonKey(name: 'fiftyTwoWeekLow')  double fiftyTwoWeekLow, @JsonKey(name: 'fiftyTwoWeekHigh')  double fiftyTwoWeekHigh, @JsonKey(name: 'regularMarketPrice')  double regularMarketPrice)?  $default,) {final _that = this;
switch (_that) {
case _AssetMetaModel() when $default != null:
return $default(_that.range,_that.validRanges,_that.fiftyTwoWeekLow,_that.fiftyTwoWeekHigh,_that.regularMarketPrice);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,range,const DeepCollectionEquality().hash(_validRanges),fiftyTwoWeekLow,fiftyTwoWeekHigh,regularMarketPrice);
...
/// Create a copy of AssetMetaModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? range = null,Object? validRanges = null,Object? fiftyTwoWeekLow = null,Object? fiftyTwoWeekHigh = null,Object? regularMarketPrice = null,}) {
